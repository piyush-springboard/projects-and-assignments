...
FROM 
    (
        SELECT sub2.membername AS membername, f.name AS facilityname, 
        CASE WHEN sub2.Type = 'Member' AND (sub2.slotNumber * f.membercost > 30) THEN sub2.slotNumber * f.membercost WHEN sub2.Type = 'Guest' 
